...
function get_locale() {
	...
	// CMLANG is defined in cm-config.
	if ( defined( 'CMLANG' ) )
		$locale = CMLANG;
 ...
 *
 * Loads the .mo file in CM_LANG_DIR constant path from WordPress root. The
 ...
 * @param string $plugin_rel_path Optional. Relative path to CM_PLUGIN_DIR. This is the preferred argument to use. It takes precendence over $abs_rel_path
 */
function load_plugin_textdomain( $domain, $abs_rel_path = false, $plugin_rel_path = false ) {
	$locale = get_locale();

	if ( false !== $plugin_rel_path	)
		$path = CM_PLUGIN_DIR . '/' . trim( $plugin_rel_path, '/' );
